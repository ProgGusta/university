...
int main()
{
    ...
    */
    ...
    code[ 1].f =  LIT; code[ 1].l =  0; code[ 1].a = 10;
    code[ 2].f =  STO; code[ 2].l =  0; code[ 2].a =  3;
    code[ 3].f =  LIT; code[ 3].l =  0; code[ 3].a =  4;
    ...
    code[ 9].f =  LOD; code[ 9].l =  0; code[ 9].a =  5;
    code[10].f =  LOD; code[10].l =  0; code[10].a =  6;
    code[11].f =  OPR; code[11].l =  0; code[11].a =  5;
    code[12].f =  STO; code[12].l =  0; code[12].a =  5;
    code[13].f =  LOD; code[13].l =  0; code[13].a =  4;
    code[14].f =  LOD; code[14].l =  0; code[14].a =  5;
    code[15].f =  OPR; code[15].l =  0; code[15].a =  4;
