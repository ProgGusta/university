...
int main()
{
    ...
    */
    ...
    code[ 1].f =  LIT; code[ 1].l =  0; code[ 1].a = 20;
    ...
    code[ 8].f =  LOD; code[ 8].l =  0; code[ 8].a =  5;
    code[ 9].f =  OPR; code[ 9].l =  0; code[ 9].a =  2;
    code[10].f =  STO; code[10].l =  0; code[10].a =  4;
    code[11].f =  LOD; code[11].l =  0; code[11].a =  3;
    code[12].f =  LOD; code[12].l =  0; code[12].a =  4;
    code[13].f =  OPR; code[13].l =  0; code[13].a =  5;
    code[14].f =  STO; code[14].l =  0; code[14].a =  3;
    code[15].f =  LIT; code[15].l =  0; code[15].a =  4;
    code[16].f =  STO; code[16].l =  0; code[16].a =  4;
    code[17].f =  LOD; code[17].l =  0; code[17].a =  3;
    code[18].f =  LOD; code[18].l =  0; code[18].a =  4;
    code[19].f =  OPR; code[19].l =  0; code[19].a =  3;
